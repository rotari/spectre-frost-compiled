...
class DisableLanguageManager extends ConfigurableLanguageManager {
  ...
  /**
   * Get all configurable languages.
   *
   * @return mixed
   *   Empty array or list of successfully loaded configuration objects,
   *   keyed by name.
   */
  ...
  /**
   * Return an array of disabled languages.
   *
   * @return array
   *   Return an array of languages that are disabled. Can be empty.
   */
   ...
   *
   * @return array
   *   Return an array of languages that are enabled. Can be empty.
   */
  ...
  /**
   * Checks if the current language is disabled.
   *
   * @return bool
   *   Returns true if the current language is disabled and false if it is not.
   */
  public function isCurrentLanguageDisabled() {
    ...
    if (isset($disabledLangCodes) && in_array(
  ...
  /**
   * Get the first enabled language.
   *
   * @return mixed
   *   Returns the first language that is enabled.
   */
